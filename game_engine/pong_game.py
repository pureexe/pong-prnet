...
class PongGame:
    ...
    def make_move(self, velocity_a = 0, velocity_b = 0):
        ...
        if a_scored or b_scored:
            ...
            ball.v_x *= -1
        paddle_a.make_move(board, velocity_a)
        paddle_b.make_move(board, velocity_b)
    ...
    def draw(self, frame):
        ...
        cv2.addWeighted(frame, 0.7, frame_clone, 0.3, 0.0, frame)
